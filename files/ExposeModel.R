...
load("/app/mymodel.rda")
# load("C:\\Users\\mafis\\source\\repos\\DemoModelExpose\\DemoModelExpose\\mymodel.rda")
...
function(age, bp, sg_1.005, sg_1.010, sg_1.015, sg_1.020, sg_1.025, al_0, al_1, al_2,
